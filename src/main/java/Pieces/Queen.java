...
public class Queen extends Piece {
    ...
    public Queen(boolean isWhite) {
        super(isWhite);
        if (isWhite) {
            super.setPath("src/main/resources/wq.png");
            super.setIconPath("src/main/resources/swq.png");
        } else {
            super.setPath("src/main/resources/bq.png");
            super.setIconPath("src/main/resources/sbq.png");
        }
    }
