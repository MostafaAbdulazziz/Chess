...
public class Bishop extends Piece {
    ...
    public Bishop(boolean isWhite) {
        super(isWhite);
        if (isWhite) {
            super.setPath("src/main/resources/wb.png");
            super.setIconPath("src/main/resources/swb.png");
        } else {
            super.setPath("src/main/resources/bb.png");
            super.setIconPath("src/main/resources/sbb.png");
        }
    }
