...
public class King extends Piece {
    ...
    private boolean isChecked(int index, Square[] squares, int[] pos) {
        int wKingRow = 0;
        int bKingRow = 0;
        int wKingCol = 0;
        int bKingCol = 0;
        ...
        for (int i = 0; i < 64; i++) {
            if (squares[i].getPiece() != null && squares[i].getPiece().isWhite() != this.isWhite() && pos[i] != 66 && pos[i] != 6) {
