...
public class King extends Piece {
    ...
    public King(boolean isWhite) {
        super(isWhite);
        if (isWhite) {
            super.setPath("src/main/resources/wking.png");
            super.setIconPath("src/main/resources/swk.png");
        } else {
            super.setPath("src/main/resources/bking.png");
            super.setIconPath("src/main/resources/sbk.png");
        }
    }
