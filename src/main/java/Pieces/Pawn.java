...
public class Pawn extends Piece {
    ...
    public Pawn(boolean isWhite, GameWindow gameWindow) {
        ...
        if (isWhite) {
            super.setPath("src/main/resources/wp.png");
            super.setIconPath("src/main/resources/swp.png");
        } else {
            super.setPath("src/main/resources/bp.png");
            super.setIconPath("src/main/resources/sbp.png");
        }
    }
