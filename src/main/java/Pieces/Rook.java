...
public class Rook extends Piece {
    ...
    public Rook(boolean isWhite) {
        super(isWhite);
        if (isWhite) {
            super.setPath("src/main/resources/wr.png");
            super.setIconPath("src/main/resources/swr.png");
        } else {
            super.setPath("src/main/resources/br.png");
            super.setIconPath("src/main/resources/sbr.png");
        }
    }
