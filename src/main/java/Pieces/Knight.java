...
public class Knight extends Piece {
    ...
    public Knight(boolean isWhite) {
        super(isWhite);
        if (isWhite) {
            super.setPath("src/main/resources/wn.png");
            super.setIconPath("src/main/resources/swn.png");
        } else {
            super.setPath("src/main/resources/bn.png");
            super.setIconPath("src/main/resources/sbn.png");
        }
    }
